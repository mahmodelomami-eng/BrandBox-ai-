...
assert.ok(adminApi.includes("body.action === 'createBrief'"));
assert.ok(adminApi.includes("body.action === 'createTemplate'"));
assert.ok(adminApi.includes("body.action === 'updateBriefStatus'"));
assert.ok(adminApi.includes("body.action === 'updateTemplate'"));

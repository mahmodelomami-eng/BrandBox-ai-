...
const sections = {
  ...
  brand: {
    ...
    cards: [
      ['/brand-kit', 'مدير الهوية Brand Kit', 'احفظ ألوان العلامة ونبرتها لتطبيقها عند توليد الصور.', Palette],
      ['/templates', 'مكتبة القوالب', 'قوالب جاهزة لإنشاء مشاريع تصميم حسب النشاط.', FileText],
      ['/projects/images', 'تصميم بصري بالذكاء الاصطناعي', 'أنشئ اتجاهات بصرية ومفاهيم أولية بسرعة.', WandSparkles],
      ['/projects', 'مشاريع الهوية', 'اجمع مخرجات كل علامة داخل مشاريع منظمة.', Boxes],
    ],
  },
  marketing: {

...
const sections = {
  studio: {
    ...
    cards: [
      ['/images-ai', 'الصور AI', 'إنشاء وتحرير الصور والمشاهد البصرية.', ImageIcon],
      ['/video-ai', 'الفيديو AI', 'إنشاء الفيديو والمشاهد والحركة.', Video],
      ['/chat-ai', 'شات AI', 'كتابة المحتوى، الأفكار، البحث والمساعدة.', MessageSquare],
      ['/audio-ai', 'الصوت AI', 'التعليق الصوتي والصوت المدعوم بالذكاء الاصطناعي.', Sparkles],
    ],
  },
  brand: {
    ...
    cards: [
      ...
      ['/images-ai', 'تصميم بصري بالذكاء الاصطناعي', 'أنشئ اتجاهات بصرية ومفاهيم أولية بسرعة.', WandSparkles],
  ...
  marketing: {
    ...
    cards: [
      ...
      ['/chat-ai', 'كاتب المحتوى', 'صياغة منشورات، إعلانات، أفكار وسيناريوهات.', MessageSquare],
      ['/images-ai', 'التصاميم التسويقية', 'إنشاء الصور والمفاهيم الإعلانية.', ImageIcon],
  ...
  print: {
    ...
    cards: [
      ...
      ['/images-ai', 'تجهيز التصميم', 'إنشاء مفاهيم وصور قبل مرحلة التنفيذ.', ImageIcon],

...
export async function GET(request: NextRequest) {
  ...
  let query = createPrivilegedSupabaseClient()
    ...
    .select('model_id,vendor_name,generation_type,tool_category,display_name_ar,display_name_en,public_description_ar,minimum_plan_id,is_featured,sort_order')
    .eq('is_enabled', true)

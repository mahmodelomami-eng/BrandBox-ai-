  ...
  return (
    <AuthGate>
      <Suspense fallback={<AdminLoadingState />}>
        <AdminControlCenter />
        <Link href="/admin/trends" className="bb-surface-elevated fixed bottom-36 left-5 z-[80] flex items-center gap-2 rounded-2xl border border-[var(--bb-accent)] px-4 py-3 text-xs font-black text-[var(--bb-accent)] shadow-[var(--bb-shadow-lg)] transition hover:bg-[var(--bb-accent-soft)]" title="إدارة Trend Lab">
